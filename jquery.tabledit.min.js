...
! function(t) {
    ...
    t.fn.Tabledit = function(e) {
        ...
        var i = this,
            a = { url: window.location.href, inputClass: "form-control input-sm", toolbarClass: "btn-toolbar", groupClass: "btn-group btn-group-sm", dangerClass: "danger", warningClass: "warning", mutedClass: "text-muted", eventType: "click", rowIdentifier: "id", hideIdentifier: !1, autoFocus: !0, editButton: !0, deleteButton: !0, saveButton: !0, restoreButton: !0, buttons: { edit: { "class": "btn btn-sm btn-default", html: '<span style="color: #fff;"><i class="fas fa-pencil-alt"></i></span>', action: "edit" }, "delete": { "class": "btn btn-sm btn-default", html: '<span style="color: #C72606;"><i class="fas fa-trash-alt"></i></span>', action: "delete" }, save: { "class": "btn btn-sm btn-success", html: "Save" }, restore: { "class": "btn btn-sm btn-warning", html: "Restore", action: "restore" }, confirm: { "class": "btn btn-secondary btn-block", html: "Confirm" } }, onDraw: function() {}, onSuccess: function() {}, onFail: function() {}, onAlways: function() {}, onAjax: function() {} },
            d = t.extend(!0, a, e),
            s = "undefined",
            o = "undefined",
            l = "undefined",
